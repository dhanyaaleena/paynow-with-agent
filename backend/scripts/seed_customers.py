...
async def seed():
    async with AsyncSessionLocal() as session:
        ...
        customers = [
            ...
            Customer(id="c_123", name="Test Customer", balance=1000.0),  
            Customer(id="c_789", name="Device Change Customer", balance=2000.0), 
            Customer(id="c_100", name="Clean Customer", balance=15000.0),  
        ]
    ...
    print("  - c_100: 15000.0 balance (clean, no risk signals)")
    print("")
